<?php
	...
	function DeleteDupeRows($data)
	{
		...
		{
			// ŒŸØ—p”z—ñ‚É’l‚ªŒ©‚Â‚©‚ç‚È‚¯‚ê‚Î$tmp‚ÉŠi”[
	...
	if($dstData['message'] == "")
	{
		...
		{	
			...
			//---------------------------------------------------------------------------------------------------------
			// Patient, Study, Series ƒŠƒXƒg‚Ìì¬
			//---------------------------------------------------------------------------------------------------------
			$tmpPtList = array();
			$tmpStList = array();
			$tmpSrList = array();
			...
			//---------------------------------------------------------------------------------------------------------
			// Sr list‚æ‚èCADŽÀs’†EŽÀsÏ‚ÝSeries‚Ì’Tõ
			//---------------------------------------------------------------------------------------------------------
			...
			//---------------------------------------------------------------------------------------------------------
			// St list‚æ‚èSr‚È‚µStudy‚ðŒŸõ‚µAŠY“–‚ª‚ ‚ê‚Îíœ
			//---------------------------------------------------------------------------------------------------------
			if($dstData['message'] == "")
			{
			...
			//---------------------------------------------------------------------------------------------------------
			// Pt list‚æ‚èSt‚È‚µStudy‚ðŒŸõ‚µAŠY“–‚ª‚ ‚ê‚Îíœ
			//---------------------------------------------------------------------------------------------------------
			if($dstData['message'] == "")
			{
