		...
		<div class="tab-content">
			...
			<div id="cadResult">
				...
				<div class="headerArea">
					<div class="fl-l"><a onclick="location.href='../study_list.php?mode=patient&encryptedPtID={$param.encryptedPtID}';">{$patientName}&nbsp;({$patientID})&nbsp;{$age}{$sex}</a></div>
					<div class="fl-l"><img src="../img_common/share/path.gif" /><a onclick="location.href='../series_list.php?mode=study&studyInstanceUID={$param.studyInstanceUID}';">{$studyDate}&nbsp;({$studyID})</a></div>
